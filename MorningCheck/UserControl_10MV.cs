...
{
    public partial class UserControl_10MV : UserControl
    {
        public UserControl_10MV()
        {
        ...
        private void UserControl_10MV_Load(object sender, EventArgs e)
        {
        ...
        private void textBox_Value1_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                using (var context = new Entities())
                {
                    ...
                    calib = String.Format(last6Mv[0].Base_Value_10MV);
        ...
        private void button_Refresh_Chart_6MV_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                chart_DatA.Series["Delta"].YValueMembers = "Delta_10MV";
