...
{
    public partial class UserControl_18MV : UserControl
    {
        public UserControl_18MV()
        {
            InitializeComponent();
        }
        ...
        private void textBox_VALUE2_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                using (var context = new Entities())
                {
                    ...
                    calib = String.Format(last6Mv[0].Base_Value_18MV);
        ...
        private void UserControl_18MV_Load(object sender, EventArgs e)
        {
