...
{
    public partial class UserCont_6MV : UserControl
    {
        public UserCont_6MV()
        {
        ...
        private void UserCont_6MV_Load(object sender, EventArgs e)
        {
        ...
        private void textBox_Temperature_6MV_Enter(object sender, EventArgs e)
        {
        ...
        private void textBoxP_Enter(object sender, EventArgs e)
        {
            try
            {
                decimal To = 20.0M;
        ...
        private void textBox_Temperature_6MV_Leave(object sender, EventArgs e)
        {
            try
            {
                decimal To = 20.0M;
            ...
            try
            {
                ...
                try
                {
                    using (var context = new Entities())
                    {
                        ...
                        var user1 = new Data_6MV()
                        {

                            Value1 = val1cor.ToString(),
                            Value2 = val2cor.ToString(),
                            Valu3 = val3cor.ToString(),
                            Valu4 = val4cor.ToString(),
                            Data = DateTime.Parse(label_Date.Text),
                            Delta_6MV = delta,
                            Data_6MV_ID = Guid.NewGuid(),
                            User = olduser
        ...
        private void textBox_Value1_Enter(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Моля въведете стойност различна от 0");
            }

        }

        private void UserCont_6MV_Load_1(object sender, EventArgs e)
        {
        ...
        private void textBox_VALUE2_Leave(object sender, EventArgs e)
        {
            //string calib = "";
            //using (var context = new Entities())
            //{
        ...
        private void textBox_Value3_Leave(object sender, EventArgs e)
        {
            //string calib = "";
            //using (var context = new Entities())
            //{
        ...
        private void textBox_Value4_Leave(object sender, EventArgs e)
        {
            //string calib = "";
            //using (var context = new Entities())
            //{
        ...
        private void labelValue1_Delta_TextChanged(object sender, EventArgs e)
        {
           
        }

        private void label_Value1_Corr_TextChanged(object sender, EventArgs e)
        {
           
        }

        private void label_Value2_Corr_TextChanged(object sender, EventArgs e)
        {
           
        }

        private void label_Value3_Corr_TextChanged(object sender, EventArgs e)
        {
           
        }

        private void label_Value4_Corr_TextChanged(object sender, EventArgs e)
        {
            
        }

        private void labelValue2_Delta_TextChanged(object sender, EventArgs e)
        {
           
        }

        private void labelValue3_delta_TextChanged(object sender, EventArgs e)
        {
           
        }

        private void labelValue4_Delta_TextChanged(object sender, EventArgs e)
        {
        ...
        private void textBox_VALUE2_Enter(object sender, EventArgs e)
        {
            try
            {
                string calib = "";
        ...
        private void textBox_Value3_Enter(object sender, EventArgs e)
        {
            try
            {
                string calib = "";
        ...
        private void textBox_Value3_TextAlignChanged(object sender, EventArgs e)
        {
